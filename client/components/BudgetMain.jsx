...
class BudgetMain extends Component {
  ...
  componentDidMount() {
    ...
    fetch("http://localhost:3000/sql")
      ...
      .then((result) => {
        this.state.username = result.userData.name;
        ...
        for (let i = 0; i < transactionsList.length; i++) {
          ...
          date.innerHTML = `<b>date:</b> ${transactionsList[i].date.slice(
            0,
            10
          )}`;
  ...
  render() {
    return (
      <div className="container budget-container">
        ...
        <div className="header2"> Hi {this.state.username}! </div>
        ...
        <div className="budget-container">
          <h4> My Account</h4>
          <div>
            <div className="content">Total Monthly Budget: fake $1000</div>
            <div className="content">Total Spent : fake $450</div>
            <div className="content">Budget : fake $550</div>
          </div>
